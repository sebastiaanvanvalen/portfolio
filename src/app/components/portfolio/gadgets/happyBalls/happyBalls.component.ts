...
import { HappyBall } from './classes/HappyBall';
...
export class HappyBallsComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        this.image.src = '../../../../../assets/happyballs/happyHans.jpg';
        // this.myCanvas.nativeElement.height = window.innerHeight;
        this.myCanvas.nativeElement.height = document.getElementById('canvas-wrapper').clientHeight;
        this.myCanvas.nativeElement.width = document.getElementById('canvas-wrapper').clientWidth;
    ...
    changeStyle(style) {
        switch (style) {
            ...
            case 'happy':
                ...
                this.canvasObject.ballCounter = 8;
                this.canvasObject.radius = 48;
    ...
    init() {
        ...
        for (let i = 0; i < this.canvasObject.ballCounter; i++) {
            ...
            if(this.canvasObject.style === "happy") {
                this.canvasObject.balls.push(new HappyBall(x, y, this.canvasObject.radius, color, this.canvasObject.collide, this.canvasObject.coloring, this.canvasObject.style, this.image));
            } else {
